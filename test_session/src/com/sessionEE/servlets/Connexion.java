package com.sessionEE.servlets;
...
import com.sessionEE.beans.Utilisateur;
import com.sessionEE.forms.ConnexionForm;
...
public class Connexion extends HttpServlet
{
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		if (derniereConnexion != null)
		{
			...
			org.joda.time.Period periode = new org.joda.time.Period(dtDerniereConnexion, dtCourante);
